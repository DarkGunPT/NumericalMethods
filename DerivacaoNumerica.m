...
try
	...
	switch EscolhaFG
		case 1
			[x,y,dydx]=DFProgressivas_2(f,a,b,h);
			legenda='DFP2';
			legPrint='dydxDFP2';
		case 2
			[x,y,dydx]=DFRegressivas_2(f,a,b,h);
			legenda='DFR2';
			legPrint='dydxDFR2';
		case 3
			[x,y,dydx]=DFCentradas_3(f,a,b,h);
			legenda='DFC3';
			legPrint='dydxDFC3';
		case 4
			[x,y,dydx]=DFProgressivas_3(f,a,b,h);
			legenda='DFP3';
			legPrint='dydxDFP3';
		case 5
			[x,y,dydx]=DFRegressivas_3(f,a,b,h);
			legenda='DFR3';
			legPrint='dydxDFR3';
		case 6
			[x,y,dydx]=DFDerivada_2(f,a,b,h);
			legenda='DFD2';
			legPrint='dydxDFD2';
			df=diff(df);
	end
